...
output "Controller_Provider_Private_IPv4" {
  ...
  value       = metal_ip_attachment.controller_private_ipv4.cidr_notation
}

output "Controller_Provider_Public_IPv6" {
  description = "OpenStack Contoller IPv6 Address"
  value       = metal_ip_attachment.controller_public_ipv6.cidr_notation
}
